                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-600">
                                ...
                                <tbody id="tab-content-body">
                                    <x-frontend.forms.table-component :headers="[]" :data="$healthCareCategory->healthCareLists">
                                        ...
                                        @foreach ($healthCareCategory->healthCareLists as $healthCareList)
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    {{ $healthCareList->educationCategory->title_en }}
                                                </td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium ">
                                                    ...
                                                    <a type="button"
                                                        href="{{ route('registeredUser.healthCareList.testimonials.create', $healthCareList) }}"
