...
{{--            <x-frontend.forms.input-type-field :value="old('organization_name', $registeredUser?->registeredUserDetail?->organization_name)" label="Full Name" id="organization_name" name="organization_name"--}}
{{--                labelClass="w-60" type="text" />--}}
