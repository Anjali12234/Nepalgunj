        ...
        <div class="mx-5  mt-14">
            <ol class="flex items-center whitespace-nowrap">
                ...
                <li class="inline-flex items-center">
                    <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:text-neutral-500 dark:hover:text-blue-500 dark:focus:text-blue-500"
                        href="#">
                        {{ $jobCategory?->mainCategory?->title_en }}
            ...
            <form class="mt-8" action="{{ route('registeredUser.jobList.store', $jobCategory) }}" method="POST"
                ...
                <div class="block md:grid grid-cols-4 pr-16">
                    <div class="col-span-2 mr-6">
                        <x-frontend.forms.select-type-field label="Job Type" id="job_type" name="job_type"
                            labelClass="w-36" class="text-sm font-semibold" :options="[
                                'part-time' => 'Part Time',
                                'full-time' => 'Full Time',
                        ...
                        <x-frontend.forms.input-type-field :value="old('job_name')" label="Job Title" id="job_name"
                            name="job_name" spanClass="text-gray-400" labelClass="w-36" type="text"
                            class="text-sm font-semibold" />


                        <x-frontend.forms.input-type-field :value="old('contact_number')" label="Contact No" id="contact_number"
                            spanClass="text-gray-400" name="contact_number" labelClass="w-36" type="text"
                        ...
                        <x-frontend.forms.input-type-field :value="old('years_of_experience')" label="Years of Experience"
                            id="years_of_experience" type="text" spanClass="text-gray-400"
                        ...
                        <x-frontend.forms.input-type-field :value="old('gender')" label="Gender" id="gender" type="text"
                            spanClass="text-gray-400" labelClass="w-36" name="gender" class="text-sm font-semibold" />

                        <x-frontend.forms.input-type-field :value="old('salary_range')" label="Salary Range" id="salary_range"
                            type="text" spanClass="text-gray-400" labelClass="w-36" name="salary_range"
                            class="text-sm font-semibold" />
                        <x-frontend.forms.input-type-field :value="old('desired_skills_experience')" label="Desired Skills And Experience" id="desired_skills_experience"
                            type="text" spanClass="text-gray-400" labelClass="w-36" name="desired_skills_experience"
                            class="text-sm font-semibold" />


                        <x-frontend.forms.input-type-field :value="old('address')" label=" Address"
                            labelClass="w-36" id="address" spanClass="text-gray-400" name="address" type="text"
                            class="text-sm font-semibold" {{-- placeholder="Per Month" --}} />
                    </div>
                    <div class="col-span-2">
                        <x-frontend.forms.text-area-component :value="old('map_url')" label="Map Url" id="map_url"
                            spanClass="text-gray-400" name="map_url" labelClass="w-36" class="text-sm font-semibold" />
                        <x-frontend.forms.input-type-field :value="old('website_url')" label="Website Url" id="website_url"
                            spanClass="text-gray-400" name="website_url" type="text" labelClass="w-36"
                            class="text-sm font-semibold" {{-- placeholder="Per Month" --}} />

                      

                        <x-frontend.forms.input-type-field :value="old('whats_app_no')" label="Whats App" id="whats_app_no"
                            spanClass="text-gray-400" name="whats_app_no" labelClass="w-36" type="number"
                            class="text-sm font-semibold" />
