        ...
        <nav class="py-4">
            <div class="container mx-auto px-6">
                <div class="flex justify-between items-center">
                    <h1 class="text-xl font-bold text-gray-800">{{ $entertainmentList->entertainmentCategory->title }}</h1>
                    ...
                    <div class="flex space-x-2 mt-4 overflow-x-auto pb-2">
                        @foreach($entertainmentList->files as $index => $file)
                            <img src="{{ $file->file_url }}" alt="Thumbnail {{ $index + 1 }}"
                                 class="thumbnail w-24 h-[32rem] object-cover cursor-pointer rounded {{ $index === 0 ? 'active' : '' }}"
            ...
            <div class="flex flex-col lg:flex-row lg:justify-between gap-3 mt-10 lg:mt-16">
                ...
                <div class="w-full lg:w-1/2 mt-10 lg:mt-0 flex flex-col items-center">
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <a href="{{ $entertainmentList->facebook_url }}" class="p-2 rounded bg-neutral-700" target="_blank">
                            <i class="ti ti-brand-facebook text-2xl text-white"></i>
                        </a>
                        <a href="{{ $entertainmentList->twitter_url }}" class="p-2 rounded bg-neutral-700" target="_blank">
                            <i class="ti ti-brand-x text-2xl text-white"></i>
                        </a>
                        <a href="{{ $entertainmentList->youtube_link }}" class="p-2 rounded bg-neutral-700" target="_blank">
                        ...
                        <a href="https://wa.me/{{ $entertainmentList->whats_app_no }}" class="p-2 rounded bg-neutral-700" target="_blank">
