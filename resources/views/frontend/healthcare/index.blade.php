    ...
    <div class="mx-24 mt-4 font-mono">
        ...
        <div class="px-4 lg:px-6 py-10">
            <div data-hs-carousel='{"loadingClasses": "opacity-0" }' class="relative">
                <div
                    class="hs-carousel relative overflow-hidden w-full h-[20rem] md:h-[calc(80vh-106px)] bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <div
                        class="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
                        <!-- Item -->
                        <div class="hs-carousel-slide">
                            <div
                                class="h-[20rem] md:h-[calc(80vh-106px)] flex flex-col bg-[url('https://images.unsplash.com/photo-1615615228002-890bb61cac6e?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center bg-no-repeat">
                        ...
                        <div class="hs-carousel-slide">
                            <div
                                class="h-[20rem] md:h-[calc(80vh-106px)] flex flex-col bg-[url('https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center bg-no-repeat">
                                <div class="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
                                    <span class="block text-white">CoolApps</span>
                                    <span class="block text-white text-xl md:text-3xl">From mobile apps to gaming
                                        consoles</span>
                                    <div class="mt-5">
                                        <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl bg-white border border-transparent text-black hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                                            href="#">
                        ...
                        <div class="hs-carousel-slide">
                            <div
                                class="h-[20rem] md:h-[calc(80vh-106px)] flex flex-col bg-[url('https://images.unsplash.com/photo-1629666451094-8908989cae90?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center bg-no-repeat">
                                <div class="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
        ...
        <div class="px-2 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight"> Featured Doctors</h2>
        ...
        <div class="px-2 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight"> Featured Hospitals</h2>
                <p class="mt-1 text-gray-600">Meet our top Hospitals who are leading the way in medical excellence and
                    patient
                    care.</p>
            </div>
        ...
        <div class="px-2 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight"> Featured Pharmacy</h2>
                <p class="mt-1 text-gray-600">Meet our top doctors who are leading the way in medical excellence and
                    patient
                    care.</p>
            </div>
        ...
        {{-- featured Medical store --}}
        <div class="px-2 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">

            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight"> Featured Medical store</h2>
                <p class="mt-1 text-gray-600">Meet our top doctors who are leading the way in medical excellence and
                    patient
                    care.</p>
            </div>
